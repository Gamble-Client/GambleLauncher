...
const LAUNCHER_VERSION = "0.1.101";
...
async function mockInvoke(command, args = {}) {
  ...
  if (command === "launcher_api") {
    ...
    if (path === "/api/launcher/version") {
      return {
        ...
        downloads: {
          windows: { fileName: "Gamble-Client-Launcher-0.1.101-x64-setup.exe", downloadUrl: "/api/launcher/download/windows" },
          linuxRpm: { fileName: "Gamble-Client-Launcher-0.1.101-1.x86_64.rpm", downloadUrl: "/api/launcher/download/linux-rpm" },
          linuxDeb: { fileName: "Gamble-Client-Launcher_0.1.101_amd64.deb", downloadUrl: "/api/launcher/download/linux-deb" }
        }
      };
    }
  ...
  if (command === "download_launcher_update") {
    return {
      version: LAUNCHER_VERSION,
      fileName: "Gamble-Client-Launcher_0.1.101_amd64.deb",
      path: "/home/theac/Downloads/Gamble-Client-Launcher_0.1.101_amd64.deb",
