...
- Site/backend: 208 tests and static build passed. Integrated release and remote byte/hash/provenance audits passed. Current Pages deployment: `https://c4c3adad.gamble-client-b67.pages.dev`; canonical production: `https://gambleclient.org`.
...
- Site metadata/audit commits `f091ee9`/`ddacd6f`, matching payload metadata `549ecc2`; release reports remote byte/hash/provenance audit passed and Pages deployed at `https://c2b287be.gamble-client-b67.pages.dev`. Loader 1.4.25 remains immutable for rollback.
