...
- Current public launcher: `0.1.133`; current standalone loader: `1.4.25`; current client build: `20260907154631` (`1.250`).
...
## Published scoped release (2026-09-07 UTC)
...
- Release completed artifact/metadata synchronization, deployment and live verification. Immutable loader `1.4.24` remains preserved for rollback; do not overwrite it. The launcher remains immutable at `0.1.133`; the generic `knownLaunchMessage` 429 attribution is deferred because no affected raw service trace was supplied.
